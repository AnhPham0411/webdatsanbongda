        ...
        <section>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { icon: Heart, title: "Dịch vụ tận tâm", desc: "Mặt cỏ nhân tạo đạt chuẩn FIFA, hệ thống chiếu sáng hiện đại mang lại trải nghiệm thi đấu tuyệt vời.", color: "bg-red-100 text-red-600" },
                ].map((item, idx) => (
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-white rounded-3xl p-8 lg:p-12 shadow-lg border border-slate-100 overflow-hidden">
            <div className="space-y-6 order-2 lg:order-1">
                ...
                <p className="text-slate-500 text-lg leading-relaxed">
                    Khu vực sân bóng đáp ứng đầy đủ tiện nghi, cung cấp các dịch vụ như: Cho thuê bóng, áo bíp, nước giải khát, khu vực nghỉ ngơi thoáng mát.
                </p>
        ...
        <section className="relative rounded-3xl overflow-hidden bg-blue-600 py-24 px-6 text-center shadow-2xl shadow-blue-200">
             ...
             <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                 ...
                 <p className="text-blue-100 text-xl font-medium">
                     Đăng ký thành viên ngay hôm nay để nhận ưu đãi lên đến <span className="text-yellow-300 font-bold">20%</span> tiền sân.
                 </p>
